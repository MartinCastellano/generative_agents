...
# Add this block to serve static files during development using STATICFILES_DIRS
if settings.DEBUG:
    # Remove the line for STATIC_ROOT:
    # urlpatterns += static(settings.STATIC_URL, document_root=settings.STATIC_ROOT) 
    
    # Keep only this line which handles STATICFILES_DIRS:
